...
contract GEMNFTs is ERC721, Ownable {
    ...
    */
    ...
    function setGemCategory(string memory _id, uint256 _price, uint256 _supply, uint256 _fee) public adminRequired {
    ...
    */
    ...
    /**
    * Function to retrieve the data of a category
    */

    function retrieveCategoryData(string memory _id) public view returns (uint256, uint256, uint256, uint256, bool) {
        return (gemCategories[_id].price, gemCategories[_id].counter, gemCategories[_id].supply, gemCategories[_id].fee, gemCategories[_id].status);
    }
